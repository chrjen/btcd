...
(http://godoc.org/github.com/chrjen/btcd/peer)
...
```bash
$ go get -u github.com/chrjen/btcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/chrjen/btcd/peer#example-package--NewOutboundPeer)  
