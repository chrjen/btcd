...
https://github.com/chrjen/btcd/releases
...
```bash
$ go get -u github.com/chrjen/btcd/...
```
...
```bash
$ go get -u -v github.com/chrjen/btcd/...
```
...
The [integrated github issue tracker](https://github.com/chrjen/btcd/issues)
is used for this project.

## Documentation

The documentation is a work-in-progress.  It is located in the [docs](https://github.com/chrjen/btcd/tree/master/docs) folder.
