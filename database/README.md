...
```bash
$ go get -u github.com/chrjen/btcd/database
```

## Examples

* [CreateDB Example]
  (http://godoc.org/github.com/chrjen/btcd/database#example-CreateDB)  
  Demonstrates creating a new database and inserting the genesis block into it.

* [NewestSha Example]
  (http://godoc.org/github.com/chrjen/btcd/database#example-Db--NewestSha)  
