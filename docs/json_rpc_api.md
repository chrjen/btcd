...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/chrjen/btcwallet).
...
such as [btcwallet](https://github.com/chrjen/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/chrjen/btcrpcclient) package.
...
[btcrpcclient](https://github.com/chrjen/btcrpcclient) package to connect with
...
import (
	"github.com/chrjen/btcrpcclient"
